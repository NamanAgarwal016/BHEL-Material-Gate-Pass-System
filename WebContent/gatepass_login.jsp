...
<html lang="en" ng-app>
  ...
  <body>
    ...
    <img src="img_src\login_logo.jpg" alt=""  align="left" height="90"  class="logo-top" >
    <img src="img_src\gandhi-logo.png" alt="" align="right" height="90" class="logo-top">
    
    
     <p class="text-white">Bharat Heavy Electricals Limited
  ...
  <div class="container-fluid align-bottom floor-leaf">
  </div>
