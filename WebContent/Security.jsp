...
<%
	...
	action="<%=request.getContextPath()%>/Leaving" method="post"
	align="center">
	<input type="hidden" id="GatePass" name="GatePass" value=<%=userlabel%>>
<input class="btn btn-outline-primary" type="submit" value="Material Leaving">
</form>
<form name="login_form" class=""
	action="<%=request.getContextPath()%>/Returning" method="post"
	align="center">
	<input type="hidden" id="GatePass" name="GatePass" value=<%=userlabel%>>
<input class="btn btn-outline-primary" type="submit" value="Material Returning">
</form>
